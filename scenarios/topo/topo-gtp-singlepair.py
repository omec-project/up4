...
class SinglePairLeaf(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dbuf1 = self.addHost('dbuf1', cls=DualHomedDbufHost, mac='00:00:00:00:db:0f',
                             ip='140.0.99.1/24', drainIp="140.0.0.2",
                             drainMac="00:aa:00:00:00:01")
        ...
        enodeb1 = self.addHost('enodeb1', cls=IPv4Host, mac='00:00:00:00:00:10', ip='140.0.100.1/24',
                              gw='140.0.100.254')
        self.addLink(enodeb1, leaf1)  # port 3

        # enodeb IPv4 host attached to leaf 2
        enodeb2 = self.addHost('enodeb2', cls=IPv4Host, mac='00:00:00:00:00:11', ip='140.0.101.1/24',
                               gw='140.0.101.254')

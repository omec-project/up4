...
class GtpuDecapUplinkTest(P4RuntimeTest):
    ...
    def runTest(self):
        ...
        for pkt_type in ["udp"]:
            ...
            self.inner_pkt = pkt
            self.testPacket(
                self.pkt_add_gtp(pkt, out_ipv4_src, out_ipv4_dst, src_teid))
    ...
    def testPacket(self, pkt):
        ...
        self.insert(
            self.helper.build_table_entry(
                ...
                action_params={
                    "egress_spec": self.port2,
                    "dst_addr": next_hop_mac
                }))
...
class GtpuEncapDownlinkTest(P4RuntimeTest):
    ...
    def testPacket(self, pkt):
        ...
        exp_pkt = pkt.copy()
        pkt_decrement_ttl(exp_pkt)
        outer_pkt = self.pkt_add_gtp(exp_pkt, out_ipv4_src, out_ipv4_dst,
                                     dst_teid)

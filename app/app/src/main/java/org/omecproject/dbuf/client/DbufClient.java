...
public interface DbufClient {
  ...
  /**
   * Returns the UDP port used by dbuf to listen for packets to be buffered. Data plane packets sent
   * to {@link #dataplaneIp4Addr()} and this UDP port will be buffered by dbuf.
   *
   * @return UDP port
   */
  ...
  /**
   * Trigger buffer drain for the given UE IPv4 address, requesting dbuf to send buffered packets in
   * a GTP tunnel with the given destination IPv4 address and UDP port.
   *

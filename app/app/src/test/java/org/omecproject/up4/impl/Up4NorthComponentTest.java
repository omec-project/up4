...
public class Up4NorthComponentTest {
  ...
  private final Up4NorthComponent.Up4NorthService up4NorthService =
      up4NorthComponent.up4NorthService;
  PiPipeconf pipeconf;
  ...
  /**
   * Attempt to read and write from the p4runtime service, and assert that the given error is
  ...
  private void missingStateTest(Throwable expectedReadWriteError) {
    ...
    P4RuntimeOuterClass.WriteRequest writeRequest =
        P4RuntimeOuterClass.WriteRequest.getDefaultInstance();
    P4RuntimeOuterClass.ReadRequest readRequest =
        P4RuntimeOuterClass.ReadRequest.getDefaultInstance();

    MockStreamObserver<P4RuntimeOuterClass.ReadResponse> readResponseObserver =
        new MockStreamObserver<>();
    MockStreamObserver<P4RuntimeOuterClass.WriteResponse> writeResponseObserver =
        new MockStreamObserver<>();
  ...
  private void insertionTest(PiTableEntry entryToInsert) {
    MockStreamObserver<P4RuntimeOuterClass.WriteResponse> responseObserver =
        new MockStreamObserver<>();
  ...
  private void readTest(PiTableEntry entryToRead) {
    MockStreamObserver<P4RuntimeOuterClass.ReadResponse> responseObserver =
        new MockStreamObserver<>();
    P4RuntimeOuterClass.Entity entity;
    try {
  ...
  private void readCounterTest(PiCounterId counterId, long expectedPackets, long expectedBytes) {
    MockStreamObserver<P4RuntimeOuterClass.ReadResponse> responseObserver =
        new MockStreamObserver<>();
    int cellIndex = 1;
    PiCounterCell requestedCell =
        new PiCounterCell(PiCounterCellId.ofIndirect(counterId, cellIndex), 0, 0);
    P4RuntimeOuterClass.Entity entity;
    try {
  ...
  public void readIngressCounterTest() {
    readCounterTest(
        NorthConstants.INGRESS_COUNTER_ID,
        NorthTestConstants.INGRESS_COUNTER_PKTS,
  ...
  public void readEgressCounterTest() {
    readCounterTest(
        NorthConstants.EGRESS_COUNTER_ID,
        NorthTestConstants.EGRESS_COUNTER_PKTS,
  ...
  public void arbitrationTest() {
    ...
    P4RuntimeOuterClass.StreamMessageRequest request =
    ...
    assertThat(
        response.getArbitration().getStatus(),
  ...
  public void getPipelineConfigTest() {
    ...
    var getPipeRequest =
        P4RuntimeOuterClass.GetForwardingPipelineConfigRequest.newBuilder()
            .setDeviceId(NorthTestConstants.P4RUNTIME_DEVICE_ID)
            .build();

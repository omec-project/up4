...
public final class TestConstants {
  ...
  public static final int PDR_ID =
      0; // TODO: PDR ID currently not stored on writes, so all reads are 0
  ...
  public static final PacketDetectionRule UPLINK_PDR =
  ...
  public static final PacketDetectionRule DOWNLINK_PDR =
      PacketDetectionRule.builder()
          .withUeAddr(UE_ADDR)
  ...
  public static final ForwardingActionRule UPLINK_FAR =
      ForwardingActionRule.builder().setFarId(UPLINK_FAR_ID).withSessionId(SESSION_ID).build();

  public static final ForwardingActionRule DOWNLINK_FAR =
  ...
  public static final PiTableEntry UP4_UPLINK_PDR =
              ...
              PiMatchKey.builder()
                  .addFieldMatch(
                      new PiExactFieldMatch(
                          NorthConstants.SRC_IFACE_KEY,
                          ImmutableByteSequence.copyFrom(NorthConstants.IFACE_ACCESS)))
                  .addFieldMatch(
                      new PiTernaryFieldMatch(NorthConstants.TEID_KEY, TEID, ALL_ONES_32))
                  .addFieldMatch(
  ...
  public static final PiTableEntry UP4_DOWNLINK_PDR =
      PiTableEntry.builder()
          .forTable(NorthConstants.PDR_TBL)
          .withMatchKey(
              PiMatchKey.builder()
                  ...
                  .addFieldMatch(
                      new PiTernaryFieldMatch(
                          ...
                          ImmutableByteSequence.copyFrom(UE_ADDR.toOctets()),
                          ALL_ONES_32))
                  .build())
          .withAction(
              PiAction.builder()
  ...
  public static final PiTableEntry UP4_UPLINK_FAR =
      PiTableEntry.builder()
          ...
          .withMatchKey(
              PiMatchKey.builder()
                  .addFieldMatch(
                      new PiExactFieldMatch(
                          NorthConstants.FAR_ID_KEY, ImmutableByteSequence.copyFrom(UPLINK_FAR_ID)))
  ...
  public static final PiTableEntry UP4_DOWNLINK_FAR =
      PiTableEntry.builder()
          .forTable(NorthConstants.FAR_TBL)
          .withMatchKey(
              PiMatchKey.builder()
              ...
              PiAction.builder()
                  ...
                  .withParameters(
                      Arrays.asList(
                          ...
                          new PiActionParam(
                              NorthConstants.TUNNEL_TYPE_PARAM, NorthConstants.TUNNEL_TYPE_GTPU),
  ...
  public static final PiTableEntry UP4_UPLINK_INTERFACE =
      PiTableEntry.builder()
          ...
          .withAction(
              PiAction.builder()
                  ...
                  .withParameters(
                      Arrays.asList(
                          new PiActionParam(
                              NorthConstants.SRC_IFACE_PARAM, NorthConstants.IFACE_ACCESS),
                          new PiActionParam(
                              NorthConstants.DIRECTION, NorthConstants.DIRECTION_UPLINK)))
                  .build())
          .build();

  public static final PiTableEntry UP4_DOWNLINK_INTERFACE =
      PiTableEntry.builder()
          .forTable(NorthConstants.IFACE_TBL)
          .withMatchKey(
              PiMatchKey.builder()
          ...
          .withAction(
              PiAction.builder()
                  ...
                  .withParameters(
                      Arrays.asList(
                          new PiActionParam(
                              NorthConstants.SRC_IFACE_PARAM, NorthConstants.IFACE_CORE),
                          new PiActionParam(
                              NorthConstants.DIRECTION, NorthConstants.DIRECTION_DOWNLINK)))
                  .build())
          .build();

  public static final FlowRule FABRIC_UPLINK_PDR =
  ...
  public static final FlowRule FABRIC_DOWNLINK_PDR =
      DefaultFlowRule.builder()
          .forDevice(DEVICE_ID)
          .fromApp(APP_ID)
          .makePermanent()
                      ...
                      PiAction.builder()
                          ...
                          .withParameters(
                              Arrays.asList(
                                  new PiActionParam(SouthConstants.CTR_ID, COUNTER_ID),
                                  new PiActionParam(
                                      SouthConstants.FAR_ID, DOWNLINK_PHYSICAL_FAR_ID),
  ...
  public static final FlowRule FABRIC_UPLINK_FAR =
      DefaultFlowRule.builder()
          .forDevice(DEVICE_ID)
          .fromApp(APP_ID)
          .makePermanent()
  ...
  public static final FlowRule FABRIC_DOWNLINK_FAR =
      DefaultFlowRule.builder()
          .forDevice(DEVICE_ID)
          .fromApp(APP_ID)
          .makePermanent()
                      ...
                      PiAction.builder()
                          ...
                          .withParameters(
                              Arrays.asList(
                                  ...
                                  new PiActionParam(
                                      SouthConstants.TUNNEL_SRC_ADDR, S1U_ADDR.toInt()),
                                  new PiActionParam(
                                      SouthConstants.TUNNEL_DST_ADDR, ENB_ADDR.toInt()),
  ...
  public static final FlowRule FABRIC_UPLINK_INTERFACE =
      DefaultFlowRule.builder()
          .forDevice(DEVICE_ID)
          .fromApp(APP_ID)
          .makePermanent()
          ...
          .withSelector(
              DefaultTrafficSelector.builder()
                  .matchPi(
                      PiCriterion.builder()
                          .matchLpm(SouthConstants.HDR_IPV4_DST_ADDR, S1U_ADDR.toInt(), 32)
              ...
              DefaultTrafficTreatment.builder()
                  .piTableAction(
                      PiAction.builder()
                          ...
                          .withParameter(
                              new PiActionParam(
                                  SouthConstants.SRC_IFACE, SouthConstants.INTERFACE_ACCESS))
                          .build())
                  .build())
          .withPriority(DEFAULT_PRIORITY)
          .build();

  public static final FlowRule FABRIC_DOWNLINK_INTERFACE =
      DefaultFlowRule.builder()
          .forDevice(DEVICE_ID)
          .fromApp(APP_ID)
          .makePermanent()
              ...
              DefaultTrafficTreatment.builder()
                  .piTableAction(
                      PiAction.builder()
                          ...
                          .withParameter(
                              new PiActionParam(
                                  SouthConstants.SRC_IFACE, SouthConstants.INTERFACE_CORE))
                          .build())
                  .build())
          .withPriority(DEFAULT_PRIORITY)
          .build();

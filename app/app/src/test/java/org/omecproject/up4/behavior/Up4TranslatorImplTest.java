...
public class Up4TranslatorImplTest {
  ...
  public void up4EntryToUplinkFarTest() {
    ...
    try {
      ...
      assertThat("UP4 uplink FAR should correctly translate to abstract FAR without error", false);
      return;
    }
  ...
  public void fabricEntryToUplinkFarTest() {
    ...
    try {
      ...
      assertThat(
          "Fabric uplink FAR should correctly translate to abstract FAR without error", false);
      return;
    }
    assertThat("Translated FAR should be uplink.", translatedFar.forwards());
    assertThat(translatedFar, equalTo(expectedFar));
  ...
  public void up4EntryToDownlinkFarTest() {
    ...
    try {
      ...
      assertThat(
          "UP4 downlink FAR should correctly translate to abstract FAR without error", false);
      return;
    }
  ...
  public void fabricEntryToDownlinkFarTest() {
    ...
    try {
      ...
      assertThat(
          "Fabric downlink FAR should correctly translate to abstract FAR without error", false);
      return;
    }
    assertThat("Translated FAR should be downlink.", translatedFar.encaps());
    assertThat(translatedFar, equalTo(expectedFar));
  ...
  public void up4EntryToUplinkInterfaceTest() {
    ...
    try {
      ...
      assertThat(
          "UP4 uplink interface should correctly translate to abstract interface without error",
          false);
      return;
    }
  ...
  public void fabricEntryToUplinkInterfaceTest() {
    ...
    try {
      translatedInterface =
          up4Translator.fabricEntryToInterface(TestConstants.FABRIC_UPLINK_INTERFACE);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Fabric uplink interface should correctly translate to abstract interface without error",
          false);
      return;
    }
    assertThat("Translated interface should be uplink.", translatedInterface.isAccess());
  ...
  public void up4EntryToDownlinkInterfaceTest() {
    ...
    try {
      ...
      assertThat(
          "UP4 downlink interface should correctly translate to abstract interface without error",
          false);
      return;
    }
  ...
  public void fabricEntryToDownlinkInterfaceTest() {
    ...
    try {
      translatedInterface =
          up4Translator.fabricEntryToInterface(TestConstants.FABRIC_DOWNLINK_INTERFACE);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Fabric downlink interface should correctly translate to abstract interface without"
              + " error",
          false);
      return;
    }
  ...
  public void uplinkInterfaceToFabricEntryTest() {
    ...
    try {
      translatedRule =
          up4Translator.interfaceToFabricEntry(
              TestConstants.UPLINK_INTERFACE,
              TestConstants.DEVICE_ID,
              TestConstants.APP_ID,
              TestConstants.DEFAULT_PRIORITY);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Abstract uplink interface should correctly translate to Fabric interface without error",
          false);
      return;
    }
  ...
  public void downlinkInterfaceToFabricEntryTest() {
    ...
    try {
      translatedRule =
          up4Translator.interfaceToFabricEntry(
              TestConstants.DOWNLINK_INTERFACE,
              TestConstants.DEVICE_ID,
              TestConstants.APP_ID,
              TestConstants.DEFAULT_PRIORITY);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Abstract downlink interface should correctly translate to Fabric interface without"
              + " error",
          false);
      return;
    }
  ...
  public void uplinkPdrToFabricEntryTest() {
    ...
    try {
      translatedRule =
          up4Translator.pdrToFabricEntry(
              TestConstants.UPLINK_PDR,
              TestConstants.DEVICE_ID,
              TestConstants.APP_ID,
              TestConstants.DEFAULT_PRIORITY);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Abstract uplink PDR should correctly translate to Fabric PDR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void downlinkPdrToFabricEntryTest() {
    ...
    try {
      translatedRule =
          up4Translator.pdrToFabricEntry(
              TestConstants.DOWNLINK_PDR,
              TestConstants.DEVICE_ID,
              TestConstants.APP_ID,
              TestConstants.DEFAULT_PRIORITY);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Abstract downlink PDR should correctly translate to Fabric PDR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void uplinkFarToFabricEntryTest() {
    ...
    try {
      translatedRule =
          up4Translator.farToFabricEntry(
              TestConstants.UPLINK_FAR,
              TestConstants.DEVICE_ID,
              TestConstants.APP_ID,
              TestConstants.DEFAULT_PRIORITY);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Abstract uplink FAR should correctly translate to Fabric FAR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void downlinkFarToFabricEntryTest() {
    ...
    try {
      translatedRule =
          up4Translator.farToFabricEntry(
              TestConstants.DOWNLINK_FAR,
              TestConstants.DEVICE_ID,
              TestConstants.APP_ID,
              TestConstants.DEFAULT_PRIORITY);
    } catch (Up4Translator.Up4TranslationException e) {
      assertThat(
          "Abstract downlink FAR should correctly translate to Fabric FAR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void uplinkInterfaceToUp4EntryTest() {
    ...
    try {
      ...
      assertThat(
          "Abstract uplink interface should correctly translate to UP4 interface without error",
          false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  ...
  public void downlinkInterfaceToUp4EntryTest() {
    ...
    try {
      ...
      assertThat(
          "Abstract downlink interface should correctly translate to UP4 interface without error",
          false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  ...
  public void uplinkPdrToUp4EntryTest() {
    ...
    try {
      ...
      assertThat("Abstract uplink PDR should correctly translate to UP4 PDR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void downlinkPdrToUp4EntryTest() {
    ...
    try {
      ...
      assertThat(
          "Abstract downlink PDR should correctly translate to UP4 PDR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void uplinkFarToUp4EntryTest() {
    ...
    try {
      ...
      assertThat("Abstract uplink FAR should correctly translate to UP4 FAR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }
  ...
  public void downlinkFarToUp4EntryTest() {
    ...
    try {
      ...
      assertThat(
          "Abstract downlink FAR should correctly translate to UP4 FAR without error", false);
      return;
    }
    assertThat(translatedRule, equalTo(expectedRule));
  }

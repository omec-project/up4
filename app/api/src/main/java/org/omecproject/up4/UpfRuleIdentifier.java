...
public final class UpfRuleIdentifier {
  ...
  /**
   * A PDR or FAR can be globally uniquely identified by the combination of the ID of the PFCP
   * session that produced it, and the ID that the rule was assigned in that PFCP session.
   *
  ...
  public boolean equals(Object obj) {
    ...
    return (this.sessionlocalId == that.sessionlocalId)
        && (this.pfcpSessionId.equals(that.pfcpSessionId));
  }

...
public final class UpfInterface {
  ...
  /**
   * Create a core-facing UPF Interface from the given address, which will be treated as a /32
   * prefix.
   *
  ...
  /**
   * Check if this UPF interface is for packets traveling from UEs. This will be true for S1U
  ...
  /**
   * Check if this UPF interface is for packets traveling towards UEs. This will be true for UE IP
   * address pool table entries.
   *
  ...
  /**
   * Check if this UPF interface is for receiving buffered packets as they are released from the
   * dbuf buffering device.
   *
  ...
  public enum Type {
    ...
    /** Interface that receives GTP encapsulated packets. This is the type of the S1U interface. */
    ACCESS,

    /**
     * Interface that receives unencapsulated packets from the core of the network. This is the type
     * of UE IP address pool interfaces.
     */
    CORE,

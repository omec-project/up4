...
public interface Up4Translator {
  ...
  /**
   * Returns true if the given table entry is a Packet Detection Rule from the UP4 logical pipeline,
   * and false otherwise.
   *
  ...
  /**
   * Returns true if the given table entry is a Packet Detection Rule from the physical fabric
   * pipeline, and false otherwise.
   *
  ...
  /**
   * Returns true if the given table entry is a Forwarding Action Rule from the UP4 logical
   * pipeline, and false otherwise.
   *
  ...
  /**
   * Returns true if the given table entry is a Forwarding Action Rule from the physical fabric
   * pipeline, and false otherwise.
   *
  ...
  /**
   * Returns true if the given table entry is an interface table entry from the UP4 logical
   * pipeline, and false otherwise.
   *
  ...
  /**
   * Returns true if the given table entry is an interface table entry from the fabric.p4 physical
   * pipeline, and false otherwise.
   *
   ...
   */
  PacketDetectionRule fabricEntryToPdr(FlowRule entry) throws Up4TranslationException;
   ...
   * @throws Up4TranslationException if the entry cannot be translated
   */
  PacketDetectionRule up4EntryToPdr(PiTableEntry entry) throws Up4TranslationException;
   ...
   * @throws Up4TranslationException if the entry cannot be translated
   */
  ForwardingActionRule fabricEntryToFar(FlowRule entry) throws Up4TranslationException;
   ...
   * @throws Up4TranslationException if the entry cannot be translated
   */
  ForwardingActionRule up4EntryToFar(PiTableEntry entry) throws Up4TranslationException;
   ...
   * @throws Up4TranslationException if the entry cannot be translated
   */
  UpfInterface up4EntryToInterface(PiTableEntry entry) throws Up4TranslationException;
   ...
   * @throws Up4TranslationException if the entry cannot be translated
   */
  UpfInterface fabricEntryToInterface(FlowRule entry) throws Up4TranslationException;

  /**
   * Translate a ForwardingActionRule to a FlowRule to be inserted into the fabric.p4 pipeline. A
   * side effect of calling this method is the FAR object's globalFarId is assigned if it was not
   * already.
   *
   ...
   */
  FlowRule farToFabricEntry(
      ForwardingActionRule far, DeviceId deviceId, ApplicationId appId, int priority)
      throws Up4TranslationException;

  /**
   * Translate a PacketDetectionRule to a FlowRule to be inserted into the fabric.p4 pipeline. A
   * side effect of calling this method is the PDR object's globalFarId is assigned if it was not
   * already.
   *
   ...
   */
  FlowRule interfaceToFabricEntry(
  ...
  /**
   * Translate a PacketDetectionRule to a PiTableEntry for responding to UP4 logical switch read
   * requests.
   *
  ...
  /**
   * Translate a ForwardingActionRule to a PiTableEntry for responding to UP4 logical switch read
   * requests.
   *

...
/**
 * The service provided by the UP4 Device Manager. This API is a work in progress. Currently the
 * only important service it provides is retrieving the available UpfProgrammable.
 */

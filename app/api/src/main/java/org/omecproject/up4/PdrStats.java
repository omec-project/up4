...
/**
 * A structure for compactly passing PDR counter values for a given counter ID. Contains four
 * counts: Ingress Packets, Ingress Bytes, Egress Packets, Egress Bytes
 */
public final class PdrStats {
  ...
  private PdrStats(
      int cellId, long ingressPkts, long ingressBytes, long egressPkts, long egressBytes) {
    this.cellId = cellId;
  ...
  public String toString() {
    return String.format(
        "PDR-Stats:{ CellID: %d, Ingress:(%dpkts,%dbytes), Egress:(%dpkts,%dbytes) }",
  ...
  public static class Builder {
    ...
    /**
     * Set the number of packets and bytes that hit the PDR counter in the dataplane ingress
     * pipeline.
     *
    ...
    /**
     * Set the number of packets and bytes that hit the PDR counter in the dataplane egress
     * pipeline.
     *
